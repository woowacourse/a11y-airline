...
function App() {
  return (
    <div className={styles.app}>
      <a href="#main-content" className={styles.skipButton}>
        본문으로 바로가기
      </a>
      <Navigation />
      <header className={styles.header}>
        <h1 className={`${styles.title} heading-1-text`} aria-label="A11Y AIRLINE">
          A11Y AIRLINE
        </h1>
      ...
      <footer
        ...
        aria-label="이 페이지의 저작권은 A11Y AIRLINE에게 있습니다."
      >
